...
Pour cette version, on garde nos fonctions telles quelles, mais il faut maintenant réécrire le programme qu'il appelle ces fonction n fois, avec n étant une variable contenant le nombre de colonnes à dessiner.
